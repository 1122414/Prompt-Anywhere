...
pyinstaller --name "PromptAnywhere" --windowed --onedir --icon "assets/app_icon.ico" --add-data "builtin_templates;builtin_templates" --add-data ".env;." --add-data "config.yaml;." app/main.py
